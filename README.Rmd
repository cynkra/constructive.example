...
* save the script and tweak the code of `.cstr_construct.qr.qr()` and `is_corrupted_qr()`
...
* call `constructive::.cstr_new_constructor(class = c("tbl_df", "tbl", "data.frame"), constructor = "data_frame")`
* save the script and tweak the code of `.cstr_construct.tbl.data_frame()`
* call `devtools::document()`
